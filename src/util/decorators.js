...
export const catchTraversalErrors = decorateTraversals(
  (traversalFunc, traversalName) => (domElement) => {
    try {
...
export const cacheTraversals = decorateTraversals(
  (traversalFunc, traversalName) => (domElement) => {
    // Ensure cache exists
...
export const logTraversals = decorateTraversals(
  (traversalFunc, traversalName) => (domElement) => {
